...
namespace AsPartitionProcessing
{
  ...
  public delegate void LogMessageDelegate(ILogger log, string message, MessageType messageType, ModelConfiguration modelConfiguration);
  ...
  public static class PartitionProcessor
  {
    ...
    public static void PerformProcessing(ILogger log, ModelConfiguration modelConfiguration, LogMessageDelegate messageLogger)
    {
    ...
    {
      _messageLogger(_log, $"{(indented ? new String(' ', 3) : "")}{message}", messageType, _modelConfiguration);
    }
